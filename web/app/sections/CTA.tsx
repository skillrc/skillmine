export default function CTA() {
  return (
    <section id="install" className="section bg-slate-deep relative overflow-hidden">
      <div className="absolute inset-0 gradient-hero"></div>
      
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            Ready to mine some <span className="gradient-text">skills</span>?
          </h2>
          ...
          <div className="code-block p-6 text-left mb-10 max-w-2xl mx-auto">
            <div className="flex items-center justify-between mb-4">
              <span className="text-muted text-sm">Install via cargo</span>
            </div>
